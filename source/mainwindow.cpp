...
{    
    ...
    //connect(&futureWatcher, SIGNAL(finished()), worker, SLOT(ResumeRequested()),Qt::DirectConnection);
...
void MainWindow::requestedFitnessCalc(Worker::TreeContainer data)
{
  ...
  //qDebug()<<"FutureWatcher is finished";
...
void MainWindow::finished_fitness_calc(){
  //qDebug()<<"Signal received: fitness calculation finished";
...
void MainWindow::received_tree_latex_string(const QString data)
{
  ...
  //ui->equationView->setFixedHeight(80);
